...
const upazilas = {
  ...
  মাদারীপুর: ["মাদারীপুর সদর", "কালকিনী", "রাজৈর", "শিবচর"],
...
router.get("/districts/:division", (req, res) => {
  const divisionDistricts = districts[req.params.division] || [];
  res.json({
    success: true,
    data: divisionDistricts,
  });
});

// @desc    Get upazilas by district
// @route   GET /api/locations/upazilas/:district
router.get("/upazilas/:district", (req, res) => {
  const districtUpazilas = upazilas[req.params.district] || [];
  res.json({
    success: true,
    data: districtUpazilas,
  });
});
